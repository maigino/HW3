...
public class Main {
     ...
     *
     * @param playlist  The playlist to be scanned.
     * @param artists   An array of artists to filter the playlist by.
     * @param durations An array of durations to filter the playlist by.
     */
